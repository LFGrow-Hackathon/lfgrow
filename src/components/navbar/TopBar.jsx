  ...
  return (
    <>
      <div className="relative flex grid grid-cols-12 max-w-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
        ...
        <div className="col-start-2 col-span-8 sm:col-start-4 sm:col-span-6 lg:col-start-4 lg:col-span-5 2xl:col-start-5 2xl:col-span-3">
          <div className="flex items-center px-6 py-4 max-w-3xl mx-auto max-w-none mx-0 px-0">
            <Search />
          </div>
        </div>
        <div className="flex items-center col-end-13 col-span-2 lg:col-end-13 lg:col-span-3 2xl:col-end-12 2xl:col-span-3">
          <Account />
        </div>
      </div>
      <Outlet />
